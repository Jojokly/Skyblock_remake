...
public enum Power_Orb {
    ...
    Power_Orb(String name, Rarity rarity, String rawname, String headID, int time, double regenHealth, int regenMana, int Strength, String... lore) {
        this.name = name;
        this.rarity = rarity;
